...
.. image:: ../images/ultima-investigator/configuration_app/bruker_configuration_logo.png
...
.. image:: ../images/ultima-investigator/configuration_app/bruker_configuration_app_location.gif
...
.. image:: ../images/ultima-investigator/configuration_app/prairie_view_configuration_full.png
...
.. image:: ../images/ultima-investigator/tyelab_config_settings/laser_settings_original_full.png
...
.. image:: ../images/ultima-investigator/tyelab_config_settings/laser_settings_current_full.png
...
.. image:: ../images/ultima-investigator/configuration_app/prairie_view_configuration_misc.png
...
.. image:: ../images/ultima-investigator/configuration_app/microscope_base_updated.png
...
.. image:: ../images/ultima-investigator/tyelab_config_settings/uncaging_galvo_calibration_location.png
    :alt: Uncaging Galvo Calibration Location
    :align: center

.. image:: ../images/ultima-investigator/tyelab_config_settings/uncaging_galvo_calibration_selection.gif
...
.. image:: ../images/ultima-investigator/tyelab_config_settings/burn_spots_selection.png
...
.. image:: ../images/ultima-investigator/tyelab_config_settings/uncaging_galvo_calibration_steps.gif
...
.. image:: ../images/ultima-investigator/scan_settings/scan_settings_selection.png
...
users do not need to access.

.. image:: ../images/ultima-investigator/scan_settings/scan_settings_disabled.png
...
.. image:: ../images/ultima-investigator/scan_settings/scan_settings_enabled.png
...
.. image:: ../images/ultima-investigator/scan_settings/scan_settings_between_modes.gif
...
.. image:: ../images/ultima-investigator/scan_settings/scan_settings_load_default_highlighted.png
...
window. Select the ``Ultima/Investagor (Divide/5)`` option.

.. image:: ../images/ultima-investigator/scan_settings/scan_settings_default_legacy.png
...
.. image:: ../images/ultima-investigator/scan_settings/galvo_galvo/acquisition_mode_galvo.png
    :alt: The Galvo-Galvo mode is selected.
    :align: center

The Galvo-Galvo mode of image acquisition has parameters that look like this:

.. image:: ../images/ultima-investigator/scan_settings/galvo_galvo/galvo_galvo_scan_settings_general.png
...
.. image:: ../images/ultima-investigator/scan_settings/galvo_galvo/galvo_galvo_scan_settings_divider_values.png
...
.. image:: ../images/ultima-investigator/scan_settings/galvo_galvo/non_stretched_pollen_grain.png
...
.. image:: ../images/ultima-investigator/scan_settings/galvo_galvo/galvo_galvo_scan_settings_divider_values_incorrect.png
...
.. image:: ../images/ultima-investigator/scan_settings/galvo_galvo/stretched_pollen_grain.png
...
.. image:: ../images/ultima-investigator/scan_settings/galvo_galvo/scan_settings_x_scan_amplitude_reversed.png
...
.. image:: ../images/ultima-investigator/scan_settings/galvo_galvo/reversed_x_amplitude_demo.gif
...
.. image:: ../images/ultima-investigator/scan_settings/galvo_galvo/correct_x_amplitude_demo.gif
    :alt: A Demonstration of Incorrect X Scan Amplitude Settings Shows Mirroring of the FOV
    :align: center
...
.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/resonant_galvo_acquisition_mode.png
...
.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/resonant_galvo_scan_settings_general.png
...
.. image:: ../images/ultima-investigator/scan_settings/preamp_artifacts/bad_preamplifier_settings.png
...
.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/range_check_settings.gif
...
.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/preamplifier_offset_bad_lut_norm.gif
...
.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/average_bad_preamplifier_offset.png
...
.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/dark_image_bad_offset.gif
...
.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/dark_image_bad_offset.png
    :alt: A Dark Image with the artifact is displayed. Vertical lines are present through the FOV
    :align: center

An average of this looks similar to the average of the preamplifier alone:

.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/average_dark_image_bad_preamplifier_offset.png
    :alt: A Dark Image with the artifact is displayed. Vertical lines are present through the FOV
    :align: center

When you take an example recording with some pollen grains, you can see the lines present somewhat.

.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/average_pollen_grains_bad_preamplifier_offset.png
...
.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/corrected_preamplifier_settings.png
    :alt: Corrected preamplifier settings are displayed
    :align: center

Here is what it looks like in real time to change this offset value:

.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/preamplifier_offset_correction.gif
    :alt: Corrected preamplifier settings are displayed
    :align: center

Here is an example of what the corrected settings produce while collecting a dark image:

.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/dark_image_corrected_offset.gif
...
striping pattern any longer.

Here is what an individual image of the preamplfier noise with the corrected offset looks like:

.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/corrected_preamplifier_offset.png
...
.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/average_corrected_preamplifier_offset.png
    :alt: An image of the preamplifier noise alone with corrected settings is displayed
    :align: center

This is further exemplified by the average dark image collected with this offset:

.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/average_dark_image_corrected_preamplifier_offset.png
...
as prominent and the background noise is far less than before. However, do note that there is still
a form of vertical bars seen on the edges of the FOV. This is due to the nonlinear speed of the 
resonant galvo and unequal sampling of the DAQ receiving data from the PMTs.

.. image:: ../images/ultima-investigator/scan_settings/resonant_galvo/pollen_grains_corrected_offset.gif
    :alt: An recording of pollen grains with the Resonant Galvo is presented
    :align: center

The average images of pollen grains with these settings are also more free of artifacts:
...
which is forthcoming. Note that it will be an exception to interact with these settings. If
...
.. image:: ../images/ultima-investigator/scan_settings/maintenance_settings/maintenance_tab_selection.png
...
.. image:: ../images/ultima-investigator/scan_settings/maintenance_settings/maintenance_window.png
    :alt: An image of the maintenance window is presented.
    :align: center

During normal operation, there is a safety feature that magnets along the frame must be in contact with
magnets on the doors for the laser's hard shutter to open. If you need to align the laser, you will have
